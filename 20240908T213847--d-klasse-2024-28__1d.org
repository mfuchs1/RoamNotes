...
** Themen
Ab heute sollten (!) die Lernjobs für die Lernschiene fertig sein. Schlüssel beim Schulwart holen.

Erste Klassen: Der Sturm auf dem See
Zweite Klassen: Franziskus (dazu gibt es zwei Lernjobs, der "Hl. Franziskus" ist besser.)
